...
#define ADDIGNORE_REST_EXSTR	"Quitter le mode insertion, en ignorant tous les groupes restants"
...
#define ADDIGNORE_EXSTR		"Ignorer le(s) groupe(s) selectionnÅÈ(s)"
...
#define NGGETLIST_EXSTR		"Obtenir la liste complÅËte des groupes du serveur de news"
...
#define NGPOST_AND_MAIL_EXSTR	"Postet un article dans un ou plusieurs groupes de news et l'envoyer par email"
...
#define ALLIGNORE_EXSTR 	"Ignoree le(s) groupe(s) selectionnÅÈ(s)"
...
#define ALLSEARCH_EXSTR		"Rechercher dans la liste des groupes"
#define ALLLIMIT_EXSTR		"Afficher un sous ensemble de la liste des groupes"
#define ALLPOST_EXSTR		"Poster dans le groupe de news actuel"
#define ALLPOST_AND_MAIL_EXSTR	"Poster dans le groupe de news actuel et envoyer le message par email Å‡ quelqu'un"
...
#define ARTCURRENT_EXSTR	"Lire l'article sous le curseur"
#define ARTUP_EXSTR		"Avancer d'une ligne dans la liste des sujets"
#define ARTDOWN_EXSTR		"Reculer d'une ligne dans la liste des sujets"
...
#define ARTSUB_EXSTR		"S'abonner au groupe actuel"
...
#define ARTPARENT_EXSTR		"Rechercher le parent de l'article courant ou selectionnÅÈ"
#define ARTKILLSUBJECT_EXSTR	"Marquer comme lus tous les articles ayant ce sujet"
#define ARTKILLAUTHOR_EXSTR	"Marquer tous les articles de cet auteur comme lus, pour cette session seulement"
#define ARTKILLTHREAD_EXSTR	"Marquer tous les articles de ce fil comme lus"
#define ARTKILLSUBTHREAD_EXSTR	"Marquer tous les articles de ce sous-fil comme lus"
...
#define ARTPOST_MAIL_EXSTR	"Poster un article dans ce groupe de news et l'envoyer aussi par email"
#define MAIL_EXSTR		"Envoyer un email"
...
#define ARTRESORT_EXSTR		"Trier Å‡ nouveau la liste d'articles"
